...
#include "glo/VertexArray.hpp"
#include "glo/Program.hpp"
#include "glo/Buffer.hpp"
...
GLFWwindow* window;
bool KeyPressed(GLenum key) { return glfwGetKey(window, key) == GLFW_PRESS; }
void ProcessInput();

game::Camera camera = game::Camera(glm::vec3(0.0f, 0.0f, 3.0f));
float camSpeed = 2.0f;
float yaw = -90.0f;
float pitch = 0.0f;
float fov = 45.0f;
...
void UpdateTime() { dt = glfwGetTime() - curFrame;  curFrame = glfwGetTime(); }
